...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__whiteboard_js__ = __webpack_require__(26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_socket_io_client__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_socket_io_client___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_socket_io_client__);
  ...
  __WEBPACK_IMPORTED_MODULE_1_socket_io_client___default.a.on('connect', function () {
    console.log('Connected!');
  });

  __WEBPACK_IMPORTED_MODULE_1_socket_io_client___default.a.on('load', function (strokes) {

    strokes.forEach(function (stroke) {
      var start = stroke.start;
      var end = stroke.end;
      var color = stroke.color;
      __WEBPACK_IMPORTED_MODULE_0__whiteboard_js__["a" /* default */].draw(start, end, color, false);
    });

  });

  __WEBPACK_IMPORTED_MODULE_1_socket_io_client___default.a.on('draw', function (start, end, color) {
    __WEBPACK_IMPORTED_MODULE_0__whiteboard_js__["a" /* default */].draw(start, end, color, false);
  });

  __WEBPACK_IMPORTED_MODULE_0__whiteboard_js__["a" /* default */].on('draw', function (start, end, color) {
    __WEBPACK_IMPORTED_MODULE_1_socket_io_client___default.a.emit('draw', start, end, color);
  });
...
var whiteboard = new __WEBPACK_IMPORTED_MODULE_0__event_emitter__["a" /* default */]();
